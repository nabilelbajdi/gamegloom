...
def send_verification_email(to_email: str, verify_url: str) -> bool:
    ...
    <div style="font-family: sans-serif; max-width: 480px; margin: 0 auto; background: #0f0f0f; color: #fff; border-radius: 12px; padding: 40px 32px;">
      <h1 style="font-size: 24px; margin: 0 0 8px; color: #f59e0b;">GameGloom</h1>
      <h2 style="font-size: 18px; font-weight: 600; margin: 0 0 24px; color: #fff;">Verify your email</h2>
      ...
      <p style="color: #666; font-size: 13px; margin: 0 0 8px;">
        If you didn't create a GameGloom account, you can safely ignore this email.
      </p>
      <p style="color: #444; font-size: 12px; margin: 0;">
        Or copy this link: <a href="{verify_url}" style="color: #f59e0b;">{verify_url}</a>
      </p>
    </div>
    """
    ...
    try:
        resend.Emails.send({
            ...
            "to": [to_email],
            "subject": "Verify your GameGloom email",
            "html": html,
        })
