...
const GameCard = ({ game }) => {
  ...
  return (
    <Link
      ...
      className="block group relative overflow-hidden rounded-lg bg-[var(--bg-elevated-2)] border border-[var(--border-subtle)] transition-all duration-300 hover:border-[var(--border-default)]"
    >
      {/* Game Cover */}
      <div
      ...
      {/* Game Info */}
      <div className="p-3 bg-[var(--bg-elevated-2)] transition-colors duration-300">
