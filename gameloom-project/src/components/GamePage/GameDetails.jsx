...
import { Menu, Calendar, Gamepad2, Tags, Filter, Users, Building, Monitor, Joystick, BookOpen, List, Info, Clock, Gamepad } from "lucide-react";
  ...
  return (
    <div className="pt-6 md:pt-12">
      ...
      <div className="mt-4 bg-surface-dark p-3 rounded-md border-[0.5px] border-gray-800/30">
        <div className="flex items-center gap-1.5 text-gray-400 text-sm font-bold mb-2">
